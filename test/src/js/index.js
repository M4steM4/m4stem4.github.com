...
$(document).ready(function() {
  ...
  var background = {}
    background.initializr = function (){
      ...
      $this.style = {bubbles_color:"#ceff54",stroke_width:0, stroke_color :"black"};
      ...
      $this.object = $("<div style='z-inde:-1;margin:0;padding:0; overflow:hidden;position:fixed;bottom:0' id='"+$this.id+"'> </div>'").appendTo("body");
     ...
     background.generate_bubbles = function() {
       ...
       bolla.transit({top: $this.rn($this.wh/2,$this.wh/5), "transform":"scale("+rn_size+") rotate("+$this.rn(-360,360)+"deg)", opacity: 0},$this.rn($this.speed[0],$this.speed[1]), function(){
         $(this).remove();
         $this.generate_bubbles();
       })
